...
class NvidiaTradingSignals:
    def __init__(self, model_path='nvidia_model.joblib'):
    ...
    def print_trading_advice(self, signals):
        ...
        print(f"SMA 20: ${signals['technical_indicators']['sma_20']:.2f}")
        print(f"SMA 50: ${signals['technical_indicators']['sma_50']:.2f}")
        print(f"MACD: {signals['technical_indicators']['macd']:.2f}") 