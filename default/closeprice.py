...
df['Date'] = pd.to_datetime(df['Date'])  # Convert stock data Date to datetime
...
# 4. Set Target Column to Today's Close (no shift)
target = 'Close'
...
# Add the trading signals code here
trading_advisor = NvidiaTradingSignals()

# Get the latest data for analysis
latest_data = df.tail(100)  # Use last 100 days for technical indicators
